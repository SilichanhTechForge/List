...
(function(Global)
{
 ...
 Midterm_Templates=Global.Midterm_Templates=Global.Midterm_Templates||{};
 ...
 SC$1=Global.StartupCode$Midterm$Client=Global.StartupCode$Midterm$Client||{};
 ...
 {
  var newName,_,b,t,t$1,_this,L,_this$1,p,i;
  newName=Var$1.Create$1("");
  _=(b=(t=(t$1=(_this=(L=Doc.Convert(function(name)
  {
   var b$1,_this$2,p$1,i$1;
   return(b$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push(new Text.New("name",name)),_this$2)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],Midterm_Templates.listitem(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  },Client.People().v),(_this$1=new ProviderBuilder.New$1(),(_this$1.h.push(new Elt.New("listcontainer",L)),_this$1))),(_this.h.push(new VarStr.New("name",newName)),_this)),(t$1.h.push(Handler.EventQ2(t$1.k,"add",function()
  {
   return t$1.i;
  },function()
  {
   ...
   newName.Set("");
  })),t$1)),(t.h.push(Handler.EventQ2(t.k,"clear",function()
  {
   return t.i;
  },function()
  {
   Client.People().Clear();
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["name",0,null]]),(i=new TemplateInstance.New(p[1],Midterm_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Midterm_Templates.listitem=function(h)
 {
 ...
 Midterm_Templates.main=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.People=ListModel.FromSeq(["RUNNING","READING"]);
 };
